...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2020 at 06:08 PM
...
(1, '20-8101-04', 8, 1, 'student001', 'student001@student.ac.bd', '58/2 A, Mirpur,Dhaka', 'student.jpg', 'B+', 'Mr. Rahman', 'Mrs. Rahman', 2147483647, 'One', '5/08/2004', 'Male', 'Muslim', '2012-01-01', 'No', 'No', 'No', 'No');
...
--
ALTER TABLE `upload`
  MODIFY `upload_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
